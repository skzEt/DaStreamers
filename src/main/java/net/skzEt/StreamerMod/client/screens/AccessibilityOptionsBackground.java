...
public class AccessibilityOptionsBackground extends AccessibilityOptionsScreen {
    public AccessibilityOptionsBackground(Screen pLastScreen, Options pOptions) {
